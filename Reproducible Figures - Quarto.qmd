...
Pearson's correlation coefficient assumes that data are approximately linear. This can be visually assessed using my results figure. Moreover, Pearson's correlation coefficient assumes that data are distributed normally [@hashash2022a]. I have tested this in the [Supplementary Materials]{.underline} section, to validate it as an appropriate statistical method for this dataset.
...
Our Pearson's correlation coefficient analysis outputted a highly significant correlation between body mass and flipper length for each of the 3 species, which is easily visualised using Fig 2. This allows us to reject our H~0~, and is indicative of morphometric scaling between the morphological traits of body mass and flipper length in each of the 3 species.

Finally, we tested whether there was a significant difference in the strength of any of the correlations between the 3 species. Due to overlapping 95% confidence intervals of the bootstrapped Pearson's correlation coefficients, we have no evidence to suggest this.
